...
const RedPacketItem = ({ item, user, token }) => {
  ...
  return (
    ...
    >
      ...
      />
      <button type="primary" onClick={handleClaim} hidden={opened[0]} disabled={opened[0]}>
        Open
      </button>
      {opened[0] ? (
        <button type="primary" onClick={showClaimDetail}>
