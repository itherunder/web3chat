      ...
      case 'currentRoom':
        res.status(200).json({
          ...
          'data': {room: {room_id: 1, room_name: 'test', description: 'test', owner_id: 1, created_at: '2022-03-08', is_deleted: false}, messages: [
            ...
            {message_id: 1, username: 'itherunder', content: 'test2', from_id: 1, to_id: 1, room_id: 1, created_at: '2022-03-08'},
            {message_id: 1, username: 'itherunder', content: 'test3', from_id: 1, to_id: 1, room_id: 1, created_at: '2022-03-08'},
          ]}
        })
        break;
      default:
